...
def program2vec(input_file = sys.argv[1]):
    ...
    def similarities_inference(doc_id):
        """
    ...
    def any_similarities_inference(doc_id1, doc_id2):
        """
    ...
    def any_similarities_inference_used_unkdocs(doc1_words, doc2_words):
        """
    ...
    def subtraction(positive_list, negative_list):
        """
    ...
    print(similarities_inference(0))
    print(any_similarities_inference(0, 1))
    print(any_similarities_inference_used_unkdocs(separated_document_list[0], separated_document_list[1]))
    print(addition(0, 1, 5, 4))
    print(subtraction(positive_list = [0, 100], negative_list = [1, 302, 222]))
